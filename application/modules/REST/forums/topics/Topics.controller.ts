...
module.exports = {
    ...
    async postAddTopic (req, res){
        ...
        return await TopicsHelper.addTopic(userAuthenticated, parent, sTitle, sDescription, arrAttachments, arrKeywords, sCountry, sCity, sLanguage, dbLatitude, dbLongitude);
    },
