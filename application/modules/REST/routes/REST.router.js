...
var AuthenticateCtrl = require ('../users/auth/Authenticate.controller.js');
var UsersCtrl = require ('../users/Users.controller.js');
var FunctionsCtrl = require ('../common/functions/functions.controller.js');

var ForumsCtrl = require ('../forums/forums/Forums.controller.js');
var TopicsCtrl = require ('../forums/topics/Topics.controller.js');
var RepliesCtrl = require ('../forums/replies/Replies.controller.js');
var VotingCtrl = require ('../voting/Voting.controller.js');
var NotificationsCtrl = require ('../notifications/notifications/Notifications.controller.js');
var MongoImporter = require ('../../DB/mongo-importer/MongoImporter.js');

var TopContentCtrl = require ('../forums/top-content/TopContent.controller.js');
var TopForumsCtrl = require ('../forums/top-content/TopForums.controller.js');
var TopRepliesCtrl = require ('../forums/top-content/TopReplies.controller.js');

var ContentCtrl = require ('../forums/content/Content.controller.js');
var StatisticsCtrl = require ('../statistics/Statistics.controller.js');

var SearchesController = require ('../searches/Searches.controller.js');
var MetaExtractorController = require ('../../utils/meta-extractor/MetaExtractor.controller.js');
...
router.get('/test/TopContent', function (req, res, next){
    var TopContentHelper = require ('../../DB/Redis/lists/sorted-lists/TopObjectsList.helper.js');
...
router.get('/test/Session', function (req, res, next){
    var SessionHash = require ('../users/auth/sessions/helpers/SessionHash.helper.js');
